...
export async function getCandidateStates(_req, res) {
  try {
    return res.json(await fetchCandidateStates());
  } catch (error) {
...
export async function getCandidateOffices(_req, res) {
  try {
    return res.json(await fetchCandidateOffices());
  } catch (error) {
...
export async function getCandidateParties(_req, res) {
  try {
    return res.json(await fetchCandidateParties());
  } catch (error) {
...
export async function saveCandidateProfileLocks(req, res) {
  try {
    ...
    return res.status(500).json({ error: "Failed to save candidate profile locks" });
  }
}
...
export async function saveCandidateProfileEdits(req, res) {
  try {
    ...
    return res.status(500).json({ error: "Failed to save candidate profile edits" });
  }
}
