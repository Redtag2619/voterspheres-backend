...
function realtimeSessionConfiguration({ model, voice, instructions }) {
  ...
  return {
    ...
    tools: EXECUTIVE_VOICE_TOOL_DEFINITIONS,
...
export async function createExecutiveVoiceSession({ user = {}, payload = {} } = {}) {
  ...
  return {
    ...
    tools_enabled: EXECUTIVE_VOICE_TOOL_DEFINITIONS.length > 0,
