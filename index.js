...
function configuredOrigins() {
  ...
  return [
    ...
    ...(String(process.env.ADDITIONAL_ALLOWED_ORIGINS || "")
...
function isAllowedOrigin(origin) {
  ...
  // Non-browser clients such as server-to-server requests may not send Origin.
...
app.use("/api/decision-intelligence", requireAuth, decisionIntelligenceRoutes);
...
app.use("/api/campaign-finance-intelligence", requireAuth, campaignFinanceIntelligenceRoutes);
...
app.use("/api/universal-candidate-intelligence", universalCandidateIntelligenceRoutes);
